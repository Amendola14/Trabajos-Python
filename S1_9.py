...
distancia= 6371.01 * math.acos((sinLatitud1 * sinLatitud2) +
(cosLatitud1 * cosLatitud2 * cosLongitud12))

print('La distancia entre dos puntos:', distancia)